...
qq.FileUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        listElement: null,
        dragText: 'Yüklemek için resmi buraya sürükleyin',
        extraDropzones: [],
        uploadButtonText: 'Dosya Seç',
        cancelButtonText: 'İptal',
        failUploadText: 'Yükleme başarısız',

        template: '<div class="qq-uploader">' +
            '<div class="qq-upload-drop-area"><span>{dragText}</span></div>' +
            (!this._options.button ? '<div class="qq-upload-button btn btn-warning offset4">{uploadButtonText}</div>' : '') +
